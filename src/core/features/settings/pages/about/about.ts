...
export class CoreSettingsAboutPage {
    ...
    feedbackFormUrl = CoreConstants.CONFIG.feedbackFormUrl ?? 'https://ieex.com.br/excelenciamobile';
    a11yStatement = CoreConstants.CONFIG.a11yStatement ?? 'https://ieex.com.br/excelenciamobile';
